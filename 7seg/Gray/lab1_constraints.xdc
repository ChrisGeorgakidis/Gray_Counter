...
set_property PACKAGE_PIN R18 [get_ports noisy]
set_property IOSTANDARD LVCMOS33 [get_ports noisy]

set_property PACKAGE_PIN W8 [get_ports an]
set_property PACKAGE_PIN Y11 [get_ports a]
set_property PACKAGE_PIN AA11 [get_ports b]
set_property PACKAGE_PIN Y10 [get_ports c]
set_property PACKAGE_PIN AA9 [get_ports d]
set_property PACKAGE_PIN W12 [get_ports e]
set_property PACKAGE_PIN W11 [get_ports f]
set_property PACKAGE_PIN V10 [get_ports g]
